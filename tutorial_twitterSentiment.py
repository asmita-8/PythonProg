...
# tweets = pd.read_csv("/home/ibab/movedfiles/Tweets.csv")
# #print(tweets)
# list(tweets.columns.values)
# sentiment_counts = tweets.airline_sentiment.value_counts()
# number_of_tweets = tweets.tweet_id.count()
# #print(sentiment_counts, number_of_tweets)
#
# import nltk, re
...
#     return lemmas
# result = normalizer("this is an example of the function.")
# #print(result)
#
...
#             cnt[word] += 1
#     return cnt
# b = tweets[(tweets.airline_sentiment == 'negative')][['grams']].apply(count_words)['grams'].most_common(20)
# #print(b)
# c = tweets[(tweets.airline_sentiment == 'positive')][['grams']].apply(count_words)['grams'].most_common(20)
# #print(c)
#
...
# w = clf.score(data_test, targets_test)
# #print(w)
...
# y = list(map(lambda p: tweets.iloc[data_test_index[int(p[1])].toarray()[0][0]].text, margin[0:10]))
# #print(y)
